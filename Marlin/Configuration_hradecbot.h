...
#define HOMING_FEEDRATE {150*60, 150*60, 50*60, 0}  // set the homing speeds (mm/min)
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 150,10} // X,Y,Z Axis Extend and Retract angles
